      ...
      <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <button
            ...
            className="flex justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full hover:bg-[#2546bd] text-white text-base font-semibold select-none"
          >
            Connect Wallet
          </button>
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            <div className={`rounded-tl-md ${companyCommonStyles}`}>
              Reliability
            </div>
            <div className={companyCommonStyles}>Security</div>
            <div className={`sm:rounded-tr-md ${companyCommonStyles}`}>
              Ethereum
            </div>
            <div className={`sm:rounded-bl-md ${companyCommonStyles}`}>
              Web 3.0
            </div>
            <div className={companyCommonStyles}>Low Fees</div>
            <div className={`rounded-br-md ${companyCommonStyles}`}>
              Blockchain
            </div>
          </div>
        </div>
